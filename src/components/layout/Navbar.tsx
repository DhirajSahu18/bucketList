      ...
      <div className="section-padding py-3.5">
        <div className="container-wide flex items-center justify-between">
          ...
          <button
            ...
            className="md:hidden p-2 text-[#faf7f2] font-sans text-xs hover:text-[#FACC15] transition-colors font-bold"
        ...
        <div className="md:hidden bg-[#1c1917] border-t border-[#FAF7F2]/15 px-6 py-6 space-y-4 font-sans text-xs uppercase tracking-wider">
          ...
          <div className="pt-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block text-center py-3.5 bg-[#FACC15] text-[#1c1917] font-extrabold rounded-sm shadow-md text-xs tracking-wider"
            >
              WhatsApp Aryan & Kashshish
            </a>
          </div>
        </div>
      )}
