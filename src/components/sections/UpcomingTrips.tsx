            ...
            <div className="mb-12">
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
                  {/* Image Column */}
                  <div className="lg:col-span-7 relative aspect-[16/10] min-h-0 lg:aspect-auto lg:min-h-[320px] bg-[#faf7f2]">
                    {featuredTrip.heroImage.includes("himachal-new-year") ? (
                      <>
                        {/* Mobile: 16:9 cover_mobile */}
                        <div
                          className="lg:hidden absolute inset-0 bg-cover bg-[position:68%_85%] transition-transform duration-700 group-hover:scale-105"
                          style={{
