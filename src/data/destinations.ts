...
3. Carry valid Govt Photo ID: Required for hotel check-ins and Rohtang/Solang transit.`,
    ...
    images: [
      ...
      "/images/himachal-new-year/Cover.jpg",
      "/images/himachal-new-year/IMG_0443.jpg",
      "/images/himachal-new-year/IMG_6108.jpg",
    ],
    galleryMeta: [
      {
      ...
      {
        src: "/images/himachal-new-year/Cover.jpg",
        type: "brand",
        source: "Bucketlist Official Himachal Trip Photo",
        alt: "Travellers posing in snow-covered Himalayan mountain valley",
      },
      {
        src: "/images/himachal-new-year/IMG_0443.jpg",
        type: "brand",
        source: "Bucketlist Official Himachal Trip Photo",
        alt: "Himachal mountain highway roadtrip views and river valley",
      },
      {
        src: "/images/himachal-new-year/IMG_6108.jpg",
        type: "brand",
        source: "Bucketlist Official Himachal Trip Photo",
        alt: "Golden Temple illuminated at night in Amritsar",
      },
    ],
  },
  {
...
2. Keep hydrated and practice sun protection during afternoon beach exploring.`,
    ...
    galleryMeta: [
      ...
      {
        src: "/images/goa/Cover.jpg",
        type: "brand",
        source: "Bucketlist Official Goa Trip Photo",
        alt: "Bucketlist travellers enjoying coastal beach views in Goa",
      },
      {
        src: "/images/goa/goa1.jpg",
        type: "brand",
        source: "Bucketlist Official Goa Trip Photo",
        alt: "Goa coastal beach landscape and tropical palms",
      },
      {
        src: "/images/goa/goa2.jpg",
        type: "brand",
        source: "Bucketlist Official Goa Trip Photo",
        alt: "Bucketlist community group joiners posing on Goa beach sunset",
      },
    ],
  },
  {
...
Comfortable trekking shoes with good grip, lightweight breathable clothes, rainwear/poncho for monsoon runs, sun cap, sunglasses, and personal water bottle.`,
    ...
    images: [
      ...
      "/images/gokarna/Cover.jpg",
      "/images/gokarna/gokarna1.jpg",
      "/images/gokarna/gokarna2.jpg",
    ],
    galleryMeta: [
      {
      ...
      {
        src: "/images/gokarna/Cover.jpg",
        type: "brand",
        source: "Bucketlist Official Gokarna Trip Photo",
        alt: "Bucketlist community joiners enjoying sunset view on Gokarna shoreline",
      },
      {
        src: "/images/gokarna/gokarna1.jpg",
        type: "brand",
        source: "Bucketlist Official Gokarna Trip Photo",
        alt: "Gokarna coastal shoreline and tropical palms",
      },
      {
        src: "/images/gokarna/gokarna2.jpg",
        type: "brand",
        source: "Bucketlist Official Gokarna Trip Photo",
        alt: "Bucketlist community group joiners posing on Gokarna beach sunset",
      },
    ],
  },
  {
...
Light breathable cotton clothes, sunglasses, sun hat, swimwear, light cardigan for Munnar hill evenings, and camera gear.`,
    ...
    images: [
      ...
      "/images/kerala/Cover.jpg",
      "/images/kerala/IMG_7245.jpg",
      "/images/kerala/IMG_7246.jpg",
    ],
    galleryMeta: [
      {
      ...
      {
        src: "/images/kerala/Cover.jpg",
        type: "brand",
        source: "Bucketlist Official Kerala Trip Photo",
        alt: "Lush green tea garden hills and mist in Munnar, Kerala",
      },
      {
        src: "/images/kerala/IMG_7245.jpg",
        type: "brand",
        source: "Bucketlist Official Kerala Trip Photo",
        alt: "Munnar tea plantations and green hills landscape",
      },
      {
        src: "/images/kerala/IMG_7246.jpg",
        type: "brand",
        source: "Bucketlist Official Kerala Trip Photo",
        alt: "Bucketlist community group joiners posing in Kerala",
      },
    ],
  },
  {
    ...
    slug: "rajasthan",
    heroImage: "/images/rajasthan/Cover.jpg",
    description:
      "From Udaipur's romantic City Palace and Lake Pichola boat rides to Jaisalmer's golden fort, Patwon Ki Haveli, and Thar desert camel safaris.",
    emotionalHook:
      "Golden sandstone forts rising above the desert, quiet evening boat rides on Lake Pichola, and starry nights in Thar sand dunes.",
    bestTime: "August to March",
    duration: "5 days",
    difficulty: "Easy",
    idealFor: ["Culture explorers", "Friends groups", "Solo joiners", "History lovers"],
    startingPoint: "Udaipur",
    guideContent: `## When to Visit Month by Month

August to October: Monsoon and post-monsoon freshness! Pleasant temperatures across Udaipur's lakes and refreshing breeze across Jaisalmer desert.

November to February: Peak winter royal season. Clear blue skies, comfortable palace sightseeing, and memorable desert camping.

March to April: Warm spring days ideal for evening lake rides and fort walks.

## What to Pack

Light breathable cotton wear, sunglasses, sun hat, comfortable walking shoes, light jacket for desert evenings, and camera gear.`,
    faqs: [
      {
        question: "What cities are covered in the Rajasthan trip?",
        answer:
          "The 5-day itinerary covers Udaipur (City Palace, Lake Pichola, Sajjangarh, Fateh Sagar) and Jaisalmer (Gadisar Lake, Patwon Ki Haveli, Thar Desert, Bada Bagh).",
      },
    ],
    images: [
    ...
    galleryMeta: [
      {
        src: "/images/rajasthan/Cover.jpg",
        type: "brand",
