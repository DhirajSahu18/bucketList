...
export const metadata: Metadata = {
  ...
  description:
    "Transparent cancellation and refund terms for founder-led community and private trips with TheBucketList.co.",
};
      ...
      <div className="section-padding">
        <div className="container-narrow space-y-8 bg-white border border-[#e6ded1] p-8 md:p-12 rounded shadow-xs">
          ...
          <div className="space-y-6 text-sm text-[#1c1917]/90 leading-relaxed font-sans">
            <p>
              We believe in complete financial transparency before you commit to any trip. Because we pre-book boutique hotels, campsites, and private vehicles in advance, our cancellation schedule is structured to protect both your deposit and our local host commitments.
            </p>

            <h3 className="font-serif text-xl text-[#1c1917] font-semibold pt-2">
              1. Community Trip Cancellation Schedule
            </h3>

            <div className="bg-[#faf7f2] border border-[#e6ded1] p-5 rounded space-y-3 font-sans text-xs">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-gray-500 font-medium">Non-Refundable (Transfer option subject to seat fill)</span>
              </div>
            </div>

            <h3 className="font-serif text-xl text-[#1c1917] font-semibold pt-2">
              2. Weather, Landslides & Road Closures
            </h3>
            <p>
              Mountain weather can change quickly. If a mountain pass or road is closed due to unexpected weather or landslides:
            </p>
            <ul className="list-disc pl-5 space-y-1.5 text-xs text-[#6b6257]">
              <li>Our travel captains maintain 24/7 route clearance updates and execute pre-mapped secondary circuits.</li>
            ...
            <p>
              Private trip deposits cover stay locks and vehicle reservations. Transfers and cancellations for private trips follow custom agreements established during your WhatsApp consultation.
            </p>
          </div>
