...
export default function PrivateTripsPage() {
  ...
  const featuredRoute = privateTripExamples[0]; // Himachal & Kasol Custom Run
  const remainingRoutes = privateTripExamples.slice(1);

  return (
    <div className="bg-[#1c1917] min-h-screen font-sans">
      {/* 1. CINEMATIC HERO PANEL — Starts Seamlessly Below Fixed Navbar (ZERO Light Gap) */}
      ...
      <section className="section-padding py-16 md:py-24 bg-white border-b border-[#e6ded1] text-[#1c1917]">
        <div className="container-wide space-y-12">
          ...
          {featuredRoute && (
            <div className="mb-12">
              <div className="group relative block bg-white border border-[#e6ded1] rounded-sm overflow-hidden hover:border-[#1c1917] transition-all duration-300 shadow-sm font-sans">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
                  ...
                  <div className="lg:col-span-5 p-6 sm:p-8 md:p-10 flex flex-col justify-between space-y-6">
                    <div className="space-y-4">
                      ...
                      <h3 className="font-serif text-2xl sm:text-3xl text-[#1c1917] font-extrabold leading-tight">
                        {featuredRoute.title}
                      </h3>
                    ...
                    <div className="pt-6 border-t border-[#e6ded1] space-y-4 font-sans">
                      ...
                      <div className="flex items-center justify-between pt-2">
                        ...
                        <a
                          href="#consultation-form"
                          className="px-5 py-2.5 bg-[#1c1917] text-white text-xs font-extrabold rounded-xs hover:bg-[#8c4a2f] transition-colors shrink-0"
                        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
            {remainingRoutes.map((item) => (
              <div
                key={item.id}
                className="bg-white border border-[#e6ded1] rounded-sm overflow-hidden shadow-xs hover:shadow-md transition-all flex flex-col justify-between h-full min-w-0 font-sans"
              >
                <div className="space-y-4">
                  ...
                  <div className="p-6 space-y-2">
                    ...
                    <h3 className="font-serif text-2xl text-[#1c1917] font-extrabold leading-snug">
                      {item.title}
                    </h3>
                    <p className="text-xs sm:text-sm text-[#4e473e] leading-relaxed font-normal">
                      {item.description}
      ...
      <section id="consultation-form" className="section-padding py-16 md:py-24 bg-[#faf7f2] text-[#1c1917]">
