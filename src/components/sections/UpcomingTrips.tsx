      ...
      <div className="section-padding">
        <div className="container-wide">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            ...
            <Link
              href="/trips"
              className="inline-flex items-center gap-2 text-sm font-sans font-semibold text-[#1c1917] hover:text-[#8c4a2f] transition-colors"
            >
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
                  ...
                  <div className="lg:col-span-7 relative aspect-[16/10] lg:aspect-auto min-h-[340px]">
                    ...
                    <div className="absolute top-4 left-4 px-3 py-1 bg-[#1c1917] text-[#FACC15] text-xs font-sans font-bold uppercase tracking-wider rounded-xs">
                      Flagship Campaign
                    </div>
                  </div>
                  ...
                  <div className="lg:col-span-5 p-6 sm:p-8 lg:p-10 flex flex-col justify-between space-y-6">
                    <div className="space-y-4">
                      <div className="flex items-center justify-between text-xs font-sans text-[#8c4a2f] font-semibold">
                        ...
                        <span className="px-2.5 py-0.5 bg-[#FACC15] text-[#1c1917] font-bold rounded">
                          {featuredTrip.seatsRemaining} seats open
                        </span>
                      </div>
                    ...
                    <div className="pt-6 border-t border-[#e6ded1] space-y-4 font-sans">
                      <div className="flex items-center justify-between text-xs text-[#6b6257]">
                        ...
                        <span>Captain: <strong className="text-[#1c1917]">{featuredTrip.founder.name}</strong></span>
                      </div>

                      <div className="flex items-center justify-between">
                        <div>
                          <span className="text-[10px] text-[#6b6257] block uppercase font-medium">Booking Amount ₹{featuredTrip.bookingAmount}</span>
                        ...
                        <span className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#1c1917] text-[#FAF7F2] text-xs font-semibold rounded group-hover:bg-[#8c4a2f] transition-colors">
